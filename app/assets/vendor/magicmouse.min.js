    ...
    763: (e, t, n) => {
      ...
      i.push([
        ...
        '',
        {
          ...
          names: [],
          mappings:
            'AACE,uBACE,cAAA,CACA,UAAA,CACA,WAAA,CACA,qBAAA,CACA,iBAAA,CACA,YAAA,CACA,MAAA,CACA,KAAA,CACA,8CAAA,CACA,mBAAA,CAEA,qCACE,eAAA,CAIJ,mBACE,UAAA,CACA,SAAA,CACA,KAAA,CACA,MAAA,CACA,cAAA,CACA,eAAA,CACA,iBAAA,CACA,mBAAA,CACA,6DAAA,CAEA,gCACE,WAAA,CACA,UAAA,CACA,eAAA,CACA,qBAAA,CACA,iCAAA,CAGF,mCACE,WAAA,CACA,UAAA,CACA,yBAAA,CACA,iCAAA,CAGF,4BACE,cAAA,CAIJ,kBACE,kBAAA,CAEA,wBACE,WAAA',
          sourcesContent: [
      ...
      function r(e, r) {
        for (var a = {}, i = [], s = 0; s < e.length; s++) {
          ...
          if (-1 !== d) (t[d].references++, t[d].updater(p))
            ...
            var h = o(p, r)
            ;((r.byIndex = s), t.splice(s, 0, { identifier: l, updater: h, references: 1 }))
          }
          i.push(l)
        }
        return i
    ...
    942: () => {
      !(function (e, t, n) {
        ...
        var l = t.documentElement,
          ...
          p = (u.testStyles = function (e, n, r, i) {
            var s,
              u,
              c,
              f,
              ...
              h = a()
            if (parseInt(r, 10))
              for (; r--;) (((c = o('div')).id = i ? i[r] : d + (r + 1)), p.appendChild(c))
            return (
        ...
        ;(c.addTest('touchevents', function () {
            ...
            for (var f in s)
              if (s.hasOwnProperty(f)) {
                ...
                for (o = r(t.fn, 'function') ? t.fn() : t.fn, a = 0; a < e.length; a++)
                  (1 === (u = e[a].split('.')).length
                    ? (c[u[0]] = o)
                    : (!c[u[0]] || c[u[0]] instanceof Boolean || (c[u[0]] = new Boolean(c[u[0]])),
                      (c[u[0]][u[1]] = o)),
                    i.push((o ? '' : 'no-') + u.join('-')))
              }
          })(),
          (function (e) {
            ...
            c._config.enableClasses &&
              ((t += ' ' + n + e.join(' ' + n)), d ? (l.className.baseVal = t) : (l.className = t))
          })(i),
          delete u.addTest,
...
;(() => {
  ...
  function S(e, t) {
    switch (e) {
      ...
      case 10:
        return function (e, n, r, o, a, i, s, u, c, f) {
          return t.apply(this, arguments)
        }
      default:
        throw new Error(
  ...
  const T = m(function (e, t) {
    return new I(e, t)
  })
  function M(e, t, n) {
    return function () {
      for (var r = [], o = 0, a = e, i = 0; i < t.length || o < arguments.length;) {
        var s
      ...
      return a <= 0 ? n.apply(this, r) : S(a, M(e, r, n))
    }
  }
  const P = m(function (e, t) {
    return 1 === e ? v(t) : S(e, M(e, [], t))
  })
  function N(e, t) {
  ...
  const D =
      'function' != typeof Object.keys || F
        ? v(function (e) {
            ...
            var t,
              ...
              r = [],
              o = F && z(e)
            for (t in e) !N(t, e) || (o && 'length' === t) || (r[r.length] = t)
            if (U)
              for (n = R.length - 1; n >= 0;)
                (N((t = R[n]), e) && !W(r, t) && (r[r.length] = t), (n -= 1))
            return r
          })
        : v(function (e) {
    ...
    H = m(
      C(['fantasy-land/map', 'map'], T, function (e, t) {
          ...
          case '[object Object]':
            return (function (e, t, n) {
              ...
              if ('function' == typeof n['fantasy-land/reduce'])
                return B(e, t, n, 'fantasy-land/reduce')
              if (null != n[L]) return q(e, t, n[L]())
              if ('function' == typeof n.next) return q(e, t, n)
              if ('function' == typeof n.reduce) return B(e, t, n, 'reduce')
    ...
    J = m(function (e, t) {
      ...
      return E(t) ? t.charAt(n) : t[n]
    }),
    $ = m(function (e, t) {
      if (null != t) return Z(e) ? J(e, t) : t[e]
    }),
    K = m(function (e, t) {
      return H($(e), t)
    })
  ...
  function te(e, t, n, r) {
    ...
    if ('function' == typeof e.equals || 'function' == typeof t.equals)
      return (
        'function' == typeof e.equals && e.equals(t) && 'function' == typeof t.equals && t.equals(e)
      )
    switch (i) {
      case 'Arguments':
      case 'Array':
      case 'Object':
        if (
          ...
          'Promise' ===
            ((o = e.constructor), null == (a = String(o).match(/^function (\w*)/)) ? '' : a[1])
        )
          return e === t
        break
      case 'Boolean':
    ...
    switch (i) {
      case 'Map':
        return e.size === t.size && ee(e.entries(), t.entries(), n.concat([e]), r.concat([t]))
      case 'Set':
        return e.size === t.size && ee(e.values(), t.values(), n.concat([e]), r.concat([t]))
      case 'Arguments':
      case 'Array':
      case 'Object':
      case 'Boolean':
      ...
      (e.prototype['@@transducer/step'] = function (e, t) {
        return (
          this.f(t) &&
            ((this.found = !0),
            (e =
              (n = this.xf['@@transducer/step'](e, t)) && n['@@transducer/reduced']
                ? n
  ...
  class se {
    ...
    generateDefault() {
      const e = K('name', ie)
      let t = {}
      for (let n of e) t[n] = this.getOptionByKey(n).default
      return t
    }
    isValid(e, t) {
      if (!K('name', ie).includes(e)) return (console.error(`${e} is not a valid option`), !1)
      const n = this.getOptionByKey(e)
      let r = !1
      switch (n.type) {
        case 'number':
      ...
      return (r || console.error(`${t} is not a valid value for ${e}`), r)
    }
    getOptionByKey(e) {
      return oe(ae('name', e), ie)
    }
  }
  n(942)
  const ue = (e) => {
      if ((console.log(e), (e = new se(e)), !Modernizr.touchevents)) {
        ...
        ;(document.addEventListener('mousemove', function (e) {
          ;((l = e.clientX),
            (d = e.clientY),
            setTimeout(() => {
              p || ((c = e.clientX - a / 2), (f = e.clientY - i / 2))
            }, 50))
        }),
          document.querySelectorAll('.magic-hover').forEach((t, n) => {
            ;(t.addEventListener('mouseenter', (n) => {
              switch (e.hoverEffect) {
                case 'circle-move':
                  ;(y(t), e.hoverItemMove && g(n, t))
                  break
                case 'pointer-blur':
                  v(t, 'pointer-blur')
                  break
          ...
          document.querySelectorAll('.no-cursor').forEach((e, t) => {
            ;(e.addEventListener('mouseenter', (e) => {
              ;((n.style.opacity = 0), (o.style.opacity = 0), (document.body.style.cursor = 'auto'))
            }),
        ...
        var h = () => {
          ;(n &&
            ((n.style.transform = 'matrix(1, 0, 0, 1, ' + c + ', ' + f + ')'),
            (n.style.width = a + 'px'),
            (n.style.height = i + 'px')),
            o &&
              (o.style.transform =
                'matrix(1, 0, 0, 1, ' + l + ', ' + d + ') translate3d(-50%, -50%, 0)'),
            ...
            if (((p = !0), n)) {
              ...
              e.classList.contains('magic-hover__square')
                ? (n.classList.add('cursor-square'),
                  ...
                  (a = t.width),
                  (i = t.height))
                : ((c = t.left), (f = t.top), (a = t.width), (i = t.height))
            }
...
var o = r.Z,
  a = r.z
export { o as default, a as magicMouse }
