    ...
    <section class="pt-24 sm:pt-32 md:pt-40 pb-8 px-6">
      <div class="max-w-5xl mx-auto">
        ...
        <div v-if="activeTab === '用户'" class="space-y-2">
          ...
          >
            <div
              class="w-10 h-10 rounded-full bg-cream-dark/30 dark:bg-ink-soft/20 overflow-hidden"
            >
            ...
            <button
              ...
              class="px-3 py-1.5 text-xs rounded-full bg-ink text-cream dark:bg-cream dark:text-ink"
            >
              通过
            </button>
            <button
        ...
        <div v-if="activeTab === '设置'" class="space-y-4">
          ...
          <div class="p-4 rounded-xl bg-cream-dark/20 dark:bg-ink-soft/10">
            ...
            <select
              class="w-full px-4 py-2 rounded-xl border border-cream-dark/30 dark:border-ink-soft/10 bg-transparent text-sm focus:outline-none"
            >
              <option>30 天</option>
              <option>60 天</option>
              <option>90 天</option>
